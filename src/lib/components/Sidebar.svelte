<aside class="grid grid-cols-1 grid-rows-[repeat(5,1fr)] md:grid-rows-[repeat(3,1fr)] md:place-content-around justify-around h-11/12 text-light-50 bg-[#0868b2] w-full md:w-2/11 overflow-y-auto overflow-x-hidden">
